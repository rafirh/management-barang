...
<head>
    ...
    <title>Login - PT. Gowa Motor Modern</title>
    <!-- CSS files -->
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                    ...
                    <form action="{{ route('auth.authenticate') }}" method="POST" autocomplete="off" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="email" class="form-control"
                                placeholder="Masukkan email anda" id="email"
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                ...
                                <span class="input-group-text">
                                    <a class="link-secondary" data-bs-toggle="tooltip" id="btnShowPassword"
                                        title="Show password" onclick="event.preventDefault();">
                        ...
                        <div class="mb-2">
                            <div class="d-flex">
                                <label class="form-check">
                                    <input type="checkbox" class="form-check-input" name="remember_me" value="1" {{ old('remember_me') ? 'checked' : '' }}>
            ...
            <div class="text-center text-muted mt-5">
                © All rights reserved - PT. Gowa Motor Modern
            </div>
        </div>
    </div>
